...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI() 
        {
            ...
            // CUSTOMIZE UI Label section.
            EditorGUILayout.Space();
            EditorGUILayout.LabelField(m_CustomiseUILabel, Styles.boldLabel);
            using (new EditorGUI.IndentLevelScope())
            {
        ...
        private GUIContent m_CustomiseUILabel = new GUIContent("Customize Label in UI");
