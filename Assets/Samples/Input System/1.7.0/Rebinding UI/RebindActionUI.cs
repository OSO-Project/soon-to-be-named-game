...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            //to prevent errors, disable the action before use
            action.Disable();


            // Configure the rebind.
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                //excluding mouse clicking
                .WithControlsExcluding("<Mouse>")
                .WithCancelingThrough("<Keyboard>/escape")
                .OnCancel(
                    operation =>
                    {
                        //remember to re-enable the action
                        action.Enable();
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        {
                           action.RemoveBindingOverride(bindingIndex);
                           //remove the binding and cleanup and then try again
                           CleanUp();
        ...
        [Tooltip("Optional bool field which allows you to OVERRIDE the action label with your own custom text.")]
        public bool m_OverrideActionLabel;

        [Tooltip("What text should be displayed by the action label if OVERRIDEN.")]
